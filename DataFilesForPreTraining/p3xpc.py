...
class XPlaneConnect(object):
    ...
    def __init__(self, xpHost = 'localhost', xpPort = 49009 ,port = 1, timeout = 1000):
        ...
        try:
            ...
            #xpIP = temp
            t = socket.gethostbyname(xpHost);
            #tr = socket.gethostbyaddr('0.0.0.0') ;
            print('XPPlane Host: ', t )
            xpIP = t
        ...
        print('checking Destination Addr (XPlane): ', self.xpDst)
        # Create and bind socket ... change this address as appropriate    
