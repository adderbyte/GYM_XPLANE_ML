'''
This script is compatible with py2.x 
Simply Create Python2.7 in conda environment and activate it to use.
...
import os
import sys
sys.path.insert(0,  '/home/cat/Desktop/XPlaneConnect-master/Python/src')
#restart_Bash_File = os.path.join("/home/cat/Desktop/XPlaneConnect-master/Python/src/")
import xpc
import parameters
